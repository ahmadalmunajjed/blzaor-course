...
public class OpenIddictDataSeedContributor : OpenIddictDataSeedContributorBase, IDataSeedContributor, ITransientDependency
{
    ...
    private async Task CreateScopesAsync()
    {
        ...
        {
            Name = "BlzaorBookStore", 
            DisplayName = "BlzaorBookStore API", 
            Resources = { "BlzaorBookStore" }
        });
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        // Blazor Client
        var consoleAndBlazorClientId = configurationSection["BlzaorBookStore_Blazor:ClientId"];
        if (!consoleAndBlazorClientId.IsNullOrWhiteSpace())
        {
            var blazorRootUrl = configurationSection["BlzaorBookStore_Blazor:RootUrl"]?.TrimEnd('/');
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["BlzaorBookStore_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["BlzaorBookStore_Swagger:RootUrl"]?.TrimEnd('/');
