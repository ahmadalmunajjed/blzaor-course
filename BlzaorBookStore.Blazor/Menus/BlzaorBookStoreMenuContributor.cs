using BlzaorBookStore.Blazor.Server.Menus;
using BlzaorBookStore.Localization;
using BlzaorBookStore.Permissions;
...
namespace BlzaorBookStore.Menus;

public class BlzaorBookStoreMenuContributor : IMenuContributor
{
    private readonly IConfiguration _configuration;

    public BlzaorBookStoreMenuContributor(IConfiguration configuration)
    {
    ...
    {
        var l = context.GetLocalizer<BlzaorBookStoreResource>();

        context.Menu.AddItem(new ApplicationMenuItem(
            BlzaorBookStoreMenus.Home,
            l["Menu:Home"],
            "/",
            icon: "fas fa-home",
            order: 1
        ...
        */
        ...
        if (await context.IsGrantedAsync(BlzaorBookStorePermissions.Books.Default))
        {
