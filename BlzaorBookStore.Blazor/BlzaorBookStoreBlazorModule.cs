...
public class BlzaorBookStoreBlazorModule : AbpModule
{
    ...
    private void ConfigureRouter(ServiceConfigurationContext context)
    {
        ...
        {
            options.AppAssembly = typeof(BlzaorBookStoreBlazorModule).Assembly;
        });
    }
    ...
    private void ConfigureMenu(ServiceConfigurationContext context)
    {
        ...
        {
            options.MenuContributors.Add(new BlzaorBookStoreMenuContributor(context.Services.GetConfiguration()));
        });
    }
    ...
    private void ConfigureHttpClientProxies(ServiceConfigurationContext context)
    {
        context.Services.AddHttpClientProxies(
            typeof(BlzaorBookStoreContractsModule).Assembly,
            RemoteServiceName
        );
    }
}
